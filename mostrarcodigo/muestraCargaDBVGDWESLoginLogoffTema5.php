...
<head>
    ...
    <title>Véro Grué - ProyectoTema5 CargaDBVGDWESLoginLogoffTema5</title>
    <link rel="stylesheet" href="../webroot/css/styleEjercicios.css">
</head>
<body>
    <header class="header">
         <a href="../indexLoginLogoffTema5.php">volver</a>
        <h1>Muestra CargaDBVGDWESLoginLogoffTema5</h1>
    </header>
    <main>
        <section>
            <?php 
     highlight_file('../scriptDB/CargaDBVGDWESLoginLogoffTema5.sql');
    ?>
        </section>
