...
<head>
    ...
    <title>Véro Grué - ProyectoTema5 muestraBorraDBVGDWESLoginLogoffTema5</title>
    <link rel="stylesheet" href="../webroot/css/styleEjercicios.css">
</head>
<body>
    <header class="header">
         <a href="../indexLoginLogoffTema5.php">volver</a>
        <h1>Muestra muestraBorraDBVGDWESLoginLogoffTema5</h1>
    </header>
    <main>
        <section>
            <?php 
     highlight_file('../scriptDB/BorraDBVGDWESLoginLogoffTema5.sql');
    ?>
        </section>
